...
if( !defined( 'CCS_CLS_VERSION' ) ) {
    define( 'CCS_CLS_VERSION', '2.0.0' ); // Version of plugin
}
...
if( !defined( 'CCS_CLS_TAXONOMIES' ) ) {
    define( 'CCS_CLS_TAXONOMIES', 'css-logo-showcase-cat' ); // Plugin Post Type Taxonomy
}
if( !defined( 'CCS_CLS_META_PREFIX' ) ) {
    define( 'CCS_CLS_META_PREFIX', '_ccs_cls_' ); // meta prefix
}
...
function ccs_cls_textdomain() {
    load_plugin_textdomain( 'ccs-logo-showcase-creative', false, dirname( plugin_basename(__FILE__) ) . '/languages/' );
}
...
// Admin File
require_once( CCS_CLS_DIR . '/includes/admin/class-cls-admin.php' );
